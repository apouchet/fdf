...
/*   Updated: 2019/10/24 09:03:45 by apouchet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static int		type(char c, t_printf *a)
{
...
static int		ft_flag(t_printf *a, char *str, int i)
{
	i++;
	if ((str[i] >= '0' && str[i] <= '9'))
		i = nb(str, i, a, 1);
...
static int		ft_type_nb(t_printf *a, char *str, int i)
{
...
static int		ft_tri_flag(t_printf *a, va_list ap, char *str, int i)
{
	i = ft_flag(a, str, i);
